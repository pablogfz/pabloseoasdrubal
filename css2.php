...
<div class="bolas">
    <img class="roja"src="/imagenes/roja.jpg">
    <img class="verde"src="/imagenes/verde.jpg">
    <img class="marron"src="/imagenes/marron.jpg">
    <img class="azul"src="/imagenes/azul.jpg">
    <img class="negra"src="/imagenes/negra.jpg">
</div>
<section class="lorem">
<div class="div1">
    <h2>What is Lorem Ipsum?</h2>
<p class="p1"><strong>Lorem Ipsum</strong> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard 
    dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. 
    It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. 
    It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently 
    with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
<h2>Why do we use it?</h2>
<p class="p2">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. 
...
<p class="p3">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin 
    ...
    treatise on the theory of ethics, <b>very popular during the Renaissance.</b> <q>The first line</q> <s>of Lorem Ipsum</s>, <i>"Lorem ipsum dolor sit amet.."</i>, 
    <m>comes from a line in section</m> 1.10.32.The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. 
    Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, 
    accompanied by English versions from the 1914 translation by H. Rackham.</p>
<h2>Where can I get some?</h2>
<p class="p4">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, 
  ...
  <div class="pruebagrid">
    <div>prueba de uso de grid</div>
    <p>qué lío con las pes y los divs</p>
    <div>marchando otro div</div>
      </div>    
      <div class="diplayno">
        Vamos a probar
      </div>
      ...
      <div class="doscolumnas">
        <img src="/imagenes/roja.jpg" alt="bolaroja">
        Aquí un texto
      </div>
      <div class="texto">
        <div>
        ...
        Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, 
        to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, 
        injected humour, or non-characteristic words etc.</div>
        <div>
          <div class="funcionescss">Funciones CSS</div>
          <div class="funcionescss2">Funciones CSS</div>
          <div class="funcionescss3">Funciones CSS</div>
          <div class="funcionescss4">Funciones CSS</div>
          <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, 
          by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of 
          Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum 
          generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the 
      ...
      <div class="imagenfalsa">pinguinitos</div>
