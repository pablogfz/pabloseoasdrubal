...
include $_SERVER['DOCUMENT_ROOT'].'/assets/header.php';?>
    ...
    <section>
        <video width="500" height="250" controls muted poster="https://w0.peakpx.com/wallpaper/416/206/HD-wallpaper-bear-and-seagulls-bear-water-seagulls-wild.jpg" preload="auto">
            ...
            <source src="/video/oso-pescador.mp4" type="video/ogg">
          </video>          
          <div>
            <br>
        ...
        <div>
            ...
            ID            
            Clase            
            Un elemento que tenga 2 clases en concreto            
            Una clase en un elemento concreto           
            Una clase que descienda de un elemento con otra clase           
            </p>
        </div>
    </section>
    <section id="ejemplo">
        <div>
            <p class="css2 pinguino">
                ...
                tienden a repetir trozos predefinidos cuando sea necesario, haciendo a este el único generador verdadero 
                (válido) en la Internet. Usa un diccionario de mas de 200 palabras provenientes del latín, 
    ...
    <section>
        ...
        <div>
            <p class="perro">
                Hay muchas variaciones de los pasajes de Lorem Ipsum disponibles, pero la mayoría sufrió alteraciones en alguna manera, 
                ya sea porque se le agregó humor, o palabras aleatorias que no parecen ni un poco creíbles. 
                Si vas a utilizar un pasaje de Lorem Ipsum, necesitás estar seguro de que no hay nada avergonzante</p>

                <p class="vaca">escondido en el medio del texto. Todos los generadores de Lorem Ipsum que se encuentran en Internet 
                tienden a repetir trozos predefinidos cuando sea necesario, haciendo a este el único generador verdadero 
                (válido) en la Internet. Usa un diccionario de mas de 200 palabras provenientes del latín, 
                combinadas con estructuras muy útiles de sentencias, para generar texto de Lorem Ipsum que parezca 
                razonable. Este Lorem Ipsum generado siempre estará libre de repeticiones, humor agregado o 
